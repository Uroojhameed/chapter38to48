...
//  if(userYear%100 === 0){
//    document.write("It's a leap year : "+userYear);
//     }else if(userYear%400 === 0){
//          document.write("It's a leap year : "+userYear);
//     }else if(userYear%4 === 0){
//          document.write("It's a leap year : "+userYear);
//     }else{
//           document.write("It's not a leap year : "+userYear);
//     } 
// }
...
// Q no 4
// var englishMarks =+prompt("write your english marks...");
// var mathMarks =+prompt("write your maths marks...");
// var urduMarks =+prompt("write your urdu marks...");
// var totalMarks = +prompt("write your total marks...");
// function average(englishMarks,mathMarks,urduMarks){
//     var average = Math.floor((englishMarks+mathMarks+urduMarks)/3);
//     return average
    
// }


// function percentage(englishMarks,mathMarks,urduMarks,totalMarks) {
//     var obtainMarks= englishMarks+mathMarks+urduMarks;
//     var percentage = Math.floor(obtainMarks/totalMarks*100);
//     return percentage
// }

// function Main(englishMarks,mathMarks,urduMarks,totalMarks) {
//    document.write("Average is : "+average(englishMarks,mathMarks,urduMarks)) ;
//    document.write("Percentage is : "+percentage(englishMarks,mathMarks,urduMarks,totalMarks)) ;
// }
// Main(englishMarks,mathMarks,urduMarks,totalMarks);
